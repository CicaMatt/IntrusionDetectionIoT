...
model = tree.DecisionTreeClassifier(criterion="entropy", random_state=100, min_samples_leaf=5)
# model = tree.ExtraTreeClassifier(criterion="gini", min_samples_leaf=5)
