...
pred_st = model.predict(x_testing)
...
y_eval_st = np.argmax(y_testing, axis=1)
accuracy_score = metrics.accuracy_score(y_eval_st, pred_st)
precision_score = metrics.precision_score(y_eval_st, pred_st, average='weighted', zero_division=0)
